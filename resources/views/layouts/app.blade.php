    ...
    <main class="main">
        ...
        <section id="skills" class="skills section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Skills</h2>
                <p>Kemampuan teknis dan digital yang saya pelajari dan terus kembangkan.</p>
            </div>
        ...
        <section id="resume" class="resume section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Resume</h2>
                <p>Ringkasan profil, pengalaman, pendidikan, serta keterampilan yang saya miliki sebagai fresh graduate Informatika. Saya terbuka untuk peluang kerja di bidang IT, administrasi, maupun digital.</p>
            </div>
        ...
        <section id="contact" class="contact section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Contact</h2>
                <p>Silakan hubungi saya melalui informasi berikut untuk kesempatan kerja, kolaborasi, atau pertanyaan lebih lanjut.</p>
