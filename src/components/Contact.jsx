      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Silakan hubungi saya melalui informasi berikut untuk kesempatan
            kerja, kolaborasi, atau pertanyaan lebih lanjut.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
              ...
              <p className="text-gray-600 mb-8 text-sm sm:text-base">
                Jangan ragu untuk menghubungi saya melalui informasi berikut
                jika ada pertanyaan atau peluang kerja sama.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs sm:text-sm lg:text-base">
                      afrizalardiansyah2001@gmail.com
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
              ...
              <p className="text-gray-600 mb-8 text-sm sm:text-base">
                Kirimkan pesan melalui formulir di bawah ini, saya akan segera
